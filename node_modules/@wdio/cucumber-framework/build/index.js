...
class CucumberAdapter {
    ...
    async init() {
        ...
        if (this._config.cucumberFeaturesWithLineNumbers?.length > 0) {
            this._specs = this._config.cucumberFeaturesWithLineNumbers.filter(feature => this._specs.some(spec => path.resolve(feature).startsWith(spec)));
        }
